      ...
      <div className="relative theme-container">
        ...
        <div className="grid lg:grid-cols-2 gap-8" style={{marginBottom: 'var(--space-4xl)'}}>
          {services.map((service, index) => {
            ...
            return (
              <div key={service.title} className="group relative theme-card p-8 hover:bg-slate-700/50 theme-animate-scale-in" style={{animationDelay: `${index * 150}ms`, borderRadius: 'var(--radius-3xl)', transitionDuration: 'var(--duration-slow)'}}>
                {/* Gradient Background */}
                ...
                <div className="relative">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-white group-hover:text-blue-300 transition-colors" style={{fontFamily: 'var(--font-sans)', transitionDuration: 'var(--duration-normal)'}}>
                          {service.title}
                        </h3>
                    ...
                    <ArrowRight className="w-6 h-6 text-gray-400 group-hover:text-blue-400 group-hover:translate-x-1 transition-all" style={{transitionDuration: 'var(--duration-normal)'}} />
                  </div>

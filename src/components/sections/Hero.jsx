  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden text-white" style={{backgroundColor: 'var(--section-bg)'}}>
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-emerald-500/10 blur-3xl theme-animate-pulse-glow" style={{borderRadius: 'var(--radius-full)'}}></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-teal-500/10 blur-3xl theme-animate-pulse-glow" style={{borderRadius: 'var(--radius-full)', animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="relative theme-container" style={{paddingTop: 'calc(var(--space-4xl) + var(--space-xl))', paddingBottom: 'var(--space-4xl)'}}>
        ...
        <div className="text-center mb-12 theme-animate-fade-in">
          <div className="inline-flex items-center theme-glass px-6 py-3 mb-8 hover:bg-emerald-500/10 transition-all" style={{borderRadius: 'var(--radius-full)', transitionDuration: 'var(--duration-normal)'}}>
            <Sparkles className="w-4 h-4 text-emerald-400 mr-2" />
            <span className="text-emerald-100 text-sm font-medium">Partnering with Fortune 500 Companies Worldwide</span>
        ...
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="mb-12 theme-animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <a href="#demo" className="group flex items-center justify-center space-x-3 px-8 py-4 border-2 font-semibold text-lg transition-all hover:bg-emerald-500/10" style={{borderRadius: 'var(--radius-2xl)', transitionDuration: 'var(--duration-normal)', borderColor: 'var(--primary-600)', color: 'var(--primary-400)'}}>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              return (
                <div key={index} className="theme-animate-fade-in theme-card p-6 hover:bg-slate-700/50 transition-colors" style={{animationDelay: `${index * 200}ms`, transitionDuration: 'var(--duration-normal)', borderRadius: 'var(--radius-2xl)'}}>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { number: '$2.5B+', label: 'Revenue Generated', color: 'text-emerald-400' },
              { number: '50M+', label: 'End Users Served', color: 'text-teal-400' },
              { number: '99.99%', label: 'System Reliability', color: 'text-green-400' },
              { number: '15+', label: 'Countries Deployed', color: 'text-orange-400' }
            ].map((stat, index) => (
              <div key={index} className="text-center group theme-animate-fade-in theme-card p-6 hover:bg-slate-700/50 transition-all" style={{animationDelay: `${index * 150}ms`, transitionDuration: 'var(--duration-normal)', borderRadius: 'var(--radius-2xl)'}}>

...
const Button = ({ 
  ...
  const baseClass = `inline-block text-center font-semibold rounded-lg transition-all duration-300 ${variants[variant] || variants.primary} ${sizes[size] || sizes.medium} ${className}`
